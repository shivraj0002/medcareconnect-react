...
import { useScrollTrigger, Container, Stack, Tabs, Tab, useTheme, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Drawer, SwipeableDrawer, Box } from '@mui/material'
...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        if (window.location.pathname === '/' && currentTab !== 'home') {
            ...
            setCurrentTab('about')
        } else if (window.location.pathname === '/contact' && currentTab !== 'contact') {
